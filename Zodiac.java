...
//		p6.add(label3);
		...
		animalPics.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\rat.png"))));
		animalPics.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\ox.png"))));
		animalPics.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\tiger.jpg"))));
		p7.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\rabbit.png"))));
		p7.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\dragon.png"))));
		p7.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\snake.png"))));
		p8.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\horse.jpg"))));
		p8.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\sheep.png"))));
		p8.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\monkey.png"))));
		p9.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\rooster.png"))));
		p9.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\dog.jpg"))));
		p9.add((new JLabel(new ImageIcon("C:\\Users\\User\\Desktop\\Animals\\pig.jpg"))));
